# FULL CODE STACK (FRI-15-AUGUST-2025-05-08-PM)
...
<div class="container">
  <div class="home-hero" >
    <h1><img src="{{ url_for('static', filename='icons/svg/light/number-circle-two-light.svg') }}" class="hero-step-icon" alt="Step 1: Upload" />Upload New Artwork</h1>
  </div>
