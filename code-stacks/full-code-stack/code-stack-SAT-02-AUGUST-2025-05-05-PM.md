# FULL CODE STACK (SAT-02-AUGUST-2025-05-05-PM)
    ...
    <div class="col col-6 edit-listing-col">
      ...
      <form role="form" id="edit-form" method="POST" autocomplete="off">
        ...
        <div class="artwork-info-card" id="generic-text-reworder" data-generic-text="{{ artwork.generic_text|e }}">
          ...
          <label for="generic-text-display">Original Generic Text:</label>
          <textarea id="generic-text-display" rows="6" class="long-field" readonly style="opacity: 0.7; background-color: #e9ecef;">{{ artwork.generic_text|e }}</textarea>
          <div class="button-row">
